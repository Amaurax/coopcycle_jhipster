...
class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "1gSL@hJv.tlrtO";
    private static final String UPDATED_EMAIL = "r@Upi.Ux";

    private static final String DEFAULT_PHONE = "8196059327";
    private static final String UPDATED_PHONE = "1975738968";
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.lastName(UPDATED_LAST_NAME).firstName(UPDATED_FIRST_NAME);
