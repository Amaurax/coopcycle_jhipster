...
class CooperativeResourceIT {
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).director(DEFAULT_DIRECTOR);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(UPDATED_NAME).address(UPDATED_ADDRESS).director(UPDATED_DIRECTOR);
        return cooperative;
    }
    ...
    void createCooperative() throws Exception {
        ...
        assertThat(testCooperative.getDirector()).isEqualTo(DEFAULT_DIRECTOR);
    }
    ...
    void putExistingCooperative() throws Exception {
        ...
        updatedCooperative.name(UPDATED_NAME).address(UPDATED_ADDRESS).director(UPDATED_DIRECTOR);
        ...
        assertThat(testCooperative.getDirector()).isEqualTo(UPDATED_DIRECTOR);
    }
    ...
    void partialUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.address(UPDATED_ADDRESS).director(UPDATED_DIRECTOR);
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.name(UPDATED_NAME).address(UPDATED_ADDRESS).director(UPDATED_DIRECTOR);
