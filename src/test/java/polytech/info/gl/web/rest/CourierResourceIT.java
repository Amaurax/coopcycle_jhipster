...
class CourierResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "hbipER@reQfM.LpjYesk";
    private static final String UPDATED_EMAIL = "WS7Jl@W.CJ";

    private static final String DEFAULT_PHONE = "5629555300";
    private static final String UPDATED_PHONE = "9297836897";

    private static final VehicleType DEFAULT_VEHICLE = VehicleType.BIKE;
    private static final VehicleType UPDATED_VEHICLE = VehicleType.E_SCOOTER;
    ...
    void partialUpdateCourierWithPatch() throws Exception {
        ...
        partialUpdatedCourier.lastName(UPDATED_LAST_NAME).firstName(UPDATED_FIRST_NAME).phone(UPDATED_PHONE);
