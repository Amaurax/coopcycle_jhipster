...
describe('Seller e2e test', () => {
  ...
  const sellerSample = { name: 'withdrawal', address: 'Fantastic multimedia optimize' };
  ...
  describe('new Seller page', () => {
    ...
    it('should create an instance of Seller', () => {
      cy.get(`[data-cy="name"]`).type('Pants Hat red').should('have.value', 'Pants Hat red');

      cy.get(`[data-cy="address"]`).type('FTP').should('have.value', 'FTP');
