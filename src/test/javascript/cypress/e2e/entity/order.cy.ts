...
describe('Order e2e test', () => {
  ...
  const orderSample = { number: 7352, price: 29440, orderDate: '2023-04-07T18:50:10.490Z' };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="number"]`).type('92925').should('have.value', '92925');

      cy.get(`[data-cy="price"]`).type('5783').should('have.value', '5783');

      cy.get(`[data-cy="orderDate"]`).type('2023-04-08T00:57').blur().should('have.value', '2023-04-08T00:57');

      cy.get(`[data-cy="deliveryDate"]`).type('2023-04-07T20:58').blur().should('have.value', '2023-04-07T20:58');

      cy.get(`[data-cy="deliveryAddress"]`).type('withdrawal dynamic').should('have.value', 'withdrawal dynamic');
